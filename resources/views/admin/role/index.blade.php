...
<x-admin-layout>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 d-flex justify-content-end">
                            <div class="card-tools">
                                @if(auth()->user()->role->hasPermission("role_create"))
                                <a class="btn waves-effect waves-light btn-success" href="{{ route('admin_role_create_update') }}" >
    ...
    <span class='d-none datatable_status'>{{ route('admin_role_action', ['ID', 'STATUS']) }}</span>
</x-admin-layout>
...
<script type="text/javascript">
    ...
    function loadTable(params) {
        ...
        $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin_role_list') }}" + params,
            columns: [
