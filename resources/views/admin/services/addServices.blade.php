...
@push('script')
<script src="{{asset('js/admin/services/addServices.js')}}"></script>
@endpush
...
<x-admin-layout>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin_services_save')}}" id="serviceForm" class="mb-3" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
